...
| **`SEAFLY_SHOW_USER`**       | Display the current user in the user/host segment.<br>Set to `1` to display the user.<br>Note, when `SHOW_HOST` is set to `2` then display is limited to SSH sessions. | 0             |
